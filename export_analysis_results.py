...
def export_contraction_analysis():
    ...
    for i, scenario in enumerate(scenarios):
        ...
        export_data['sample_sequences'][f'scenario_{i+1}'] = {
            ...
            'convergence_steps': len([x for x in sequence if abs(x - sequence[-1]) > 0.001])
        }
    ...
    print(f"✓ Exported contraction analysis to outputs/contraction_analysis_results.json")
...
def export_hybrid_functional_analysis():
    ...
    try:
        ...
        print(f"✓ Exported hybrid functional analysis to outputs/hybrid_functional_results.json")
        
    except ImportError:
        print("⚠ minimal_hybrid_functional.py not found, skipping hybrid analysis export")
