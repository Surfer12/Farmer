...
class TopicModelingService:
    ...
    def _simulate_training(self, documents):
        ...
        self.model = {"num_topics": 50, "documents": len(documents), "simulated": True}
    ...
    def get_topic_distribution(self, text):
        ...
        try:
            ...
            if self.model is not None and hasattr(self.model, 'transform'):
            ...
            if probabilities is not None and len(probabilities) > 0:
                ...
                topic_id = topics[0]
                if self.model is not None and hasattr(self.model, 'get_topic_info'):
                    num_topics = (
                        len(self.model.get_topic_info()) - 1
                    )  # Exclude outlier topic
                else:
                    num_topics = 50  # Default fallback
